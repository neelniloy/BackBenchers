...
public class AddRoutine extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private String day,current_user_id,sTime,eTime,format,h1,m1,classCode;
    private FirebaseAuth mAuth;
    private DatabaseReference myRoutine,userRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRoutine = FirebaseDatabase.getInstance().getReference().child("Classroom");
        ...
        addRoutine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sTime==null){
                    ...
                    myRoutine.child(classCode).child("Routine").child(day).child(""+getDateInMillis(sTime)).updateChildren(add);

                    Toast.makeText(AddRoutine.this, "Routine Added Successfully", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(AddRoutine.this, Routine.class);
