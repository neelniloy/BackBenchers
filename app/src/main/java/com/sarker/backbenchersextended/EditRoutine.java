...
public class EditRoutine extends AppCompatActivity {
    ...
    private String day,current_user_id,sTime,eTime,format,h1,m1,classTime,cName,cTeacher,cCode,rNo,key,classCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRoutine = FirebaseDatabase.getInstance().getReference().child("Classroom").child(classCode).child("Routine").child(day).child(key);
        myRoutine2 = FirebaseDatabase.getInstance().getReference().child("Classroom").child(classCode).child("Routine").child(day);
        ...
        upRoutine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty() || code.isEmpty() || teacher.isEmpty() || room.isEmpty()){
                    ...
                    Intent intent = new Intent(EditRoutine.this, Routine.class);
